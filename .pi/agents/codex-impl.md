...
- Ask Codex to implement the task in the active worktree, run relevant local verification, and avoid commit/push/PR/CI work because validator owns publish after validation passes.
